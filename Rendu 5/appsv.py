            ...
            if (choix_2==1) :
                ...
                while information != 0 : #modifier plusieurs informations d'un adhérent
                    if (information==1):
                        ...
                        cur.execute(sql_nom)
                        print("Le nom '%s' a bien été enregistré \n") %Nom_n
                    elif(information==2):
                        ...
                        print("Le numéro de téléphone '%s' a bien été enregistré \n") %Num_tele_n
                        ...
                        print("Le nombre de retard '%s' a bien été enregistré \n") %Nb_retard_n
                        ...
                        print("Le nombre de degradation '%s' a bien été enregistré \n") %Nb_degradation_n
                        ...
                        print("Le numéro de la carte '%s' a bien été enregistré \n") %Num_carte_n
