...
CREATE TABLE Ressource(
  ...
  CHECK ((Livre NOT NULL AND ISBN NOT NULL AND Langue_livre NOT NULL AND Résumé NOT NULL)
        OR (Oeuvremusicale NOT NULL AND Durée_oeuvre NOT NULL)
        OR (Film NOT NULL AND Synopsis NOT NULL AND Langue_film NOT NULL AND Durée_film NOT NULL)),
)
...
CREATE TABLE Contribue (
  FOREIGN KEY Rôle REFERENCES Contributeur(Rôle),
